        ...
        <>
            ...
            >
                <div className="card__topSection__container">
                    <div
                        className="card__topSection__container__name"
                        style={{ backgroundColor: top_color }}
                    >
                        <h4>{name}</h4>
                    </div>
                    <div
                        className="card__topSection__container__attSp"
                        style={{ backgroundColor: top_color }}
                    >
                    ...
                    <div
                        className="card__topSection__container__defSp"
                        style={{ backgroundColor: top_color }}
                    >
                        <span className="imgContainer">
                ...
                <div className="card__botSection__container">
                    <div
                        className="card__botSection__container__offensiveStats"
                    ...
                    <div
                        className="card__botSection__container__defensiveStats"
                        style={{ backgroundColor: bot_color }}
                    >
                    ...
                    <div
                        className="card__botSection__container__id"
                        style={{ backgroundColor: bot_color }}
                    >
                        <p>#{id}</p>
                    </div>
